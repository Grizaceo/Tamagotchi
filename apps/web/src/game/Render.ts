...
import { ALBUM_PAGE_SIZE, BOTTOM_MENU, CARE_ACTIONS, getIconIndexForScene, getMenuIndex, MINIGAMES, SETTINGS_ITEMS } from './Scenes';
...
export function renderFrame(
  ...
  if (options?.uiRenderer) {
    ...
    const selection = getIconIndexForScene(BOTTOM_MENU[ui.menuIndex].id);
